...
const ButtonOutlinePrimary = ({ children, onClick, style, disabled = false }) => {
    return (
        <button onClick={onClick} style={style} disabled={disabled} type='button' className='button button-outline-primary'>{ children }</button>
    )
}
